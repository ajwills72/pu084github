...
The authors thank (_withheld for masked manusciprt_) and (_withheld for masked manuscript_) for their assistance in data collection.

# Open Practices Statement {-}

None of the experiments in this article were formally preregistered. Stimulus files, raw data, and a reproducible manuscript including all analysis code, is available at (_URL withheld as disclosure would unmask manuscript_)
