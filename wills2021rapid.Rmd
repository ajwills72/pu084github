...
Twenty-four participants were tested in this experiment; the sample size was determined by the number of course credits available at the time of testing. PsychoPy software [@pierce2007psychopy], version 1.83, was used to present the stimuli and to collect responses via a standard PC keyboard and mouse. The stimuli were the same as in the two previous experiments.
